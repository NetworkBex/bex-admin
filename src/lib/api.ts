...
export const coreAPI = {
  ...
  createCurrency: (data: any) => api.post('/core/currencies/', data),
  updateCurrency: (id: number, data: any) => api.patch(`/core/currencies/${id}/`, data),
  deleteCurrency: (id: number) => api.delete(`/core/currencies/${id}/`),
  investPlans: () => api.get('/core/invest-plans/'),
  createInvestPlan: (data: any) => api.post('/core/invest-plans/', data),
  updateInvestPlan: (id: number, data: any) => api.patch(`/core/invest-plans/${id}/`, data),
  deleteInvestPlan: (id: number) => api.delete(`/core/invest-plans/${id}/`),
  testimonies: () => api.get('/core/testimonies/'),
  createTestimony: (data: any) => api.post('/core/testimonies/', data),
  updateTestimony: (id: number, data: any) => api.patch(`/core/testimonies/${id}/`, data),
  deleteTestimony: (id: number) => api.delete(`/core/testimonies/${id}/`),
  blog: () => api.get('/core/blog/'),
  createBlog: (data: any) => api.post('/core/blog/', data),
  updateBlog: (id: number, data: any) => api.patch(`/core/blog/${id}/`, data),
  deleteBlog: (id: number) => api.delete(`/core/blog/${id}/`),
